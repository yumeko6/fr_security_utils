...
class Dialog:
	...
	def choices():
		print(
			...
			'5 - Полный еженедельный отчет (включая пункты 1-4)\n'
			'6 - Еженедельный отчет по HH за произвольную дату\n'
			'7 - Еженедельный отчет по непродуктивности за произвольную дату\n'
			'8 - Завершить работу'
		)
